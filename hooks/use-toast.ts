...
export const useToast = () => {
  const toastFunction = React.useCallback(({ title, description, variant = "default" }: ToasterToast) => {
    // Simple console log for now - you can replace with actual toast implementation
    console.log(`Toast: ${title} - ${description} (${variant})`)

    // You could also show a simple alert or implement a proper toast system
