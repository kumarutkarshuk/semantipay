...
export default function TechStackSection({
  ...
  return (
    <div className="flex flex-col gap-8 h-[600px] justify-center items-center w-full bg-gradient-to-br from-red-950/30 to-gray-950/30">
      <AnimatedText
        text="Powered by cutting-edge technologies"
        variant="paragraph"
        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-bold tracking-tighter gradient-text px-4 text-center text-gray-300"
        animation="slide"
      />
      <div
        className={cn(
      ...
      >
        <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
          <div className="flex flex-col justify-center gap-2">
            <Circle ref={div1Ref}>
              <img src="/tidb.svg" alt="TiDB" />
            </Circle>
            <Circle ref={div2Ref}>
              <img src="/dify.svg" alt="Dify" />
            </Circle>
            <Circle ref={div3Ref}>
              <img src="/jina.svg" alt="Jina AI" />
            </Circle>
            <Circle ref={div4Ref}>
