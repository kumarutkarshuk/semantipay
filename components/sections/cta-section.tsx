        ...
        <ScrollReveal>
          <div className="flex flex-col items-center justify-center space-y-6 text-center">
            <div className="space-y-4">
              <AnimatedText
                text="Ready to skip compliance hassles?"
                variant="heading"
                className="text-xl font-heading font-bold tracking-tighter sm:text-5xl gradient-text"
                animation="wave"
              />
              <AnimatedText
                text="Eliminate hours wasted on chasing new compliance updates!"
                variant="paragraph"
            ...
            >
              <GradientButton
                glowAmount={5}
                size="lg"
                className="sm:px-8 sm:py-3 px-4 py-2" 
                gradientFrom="from-red-500"
                gradientTo="to-red-700"
                asChild
              >
                <Link href="/dashboard/payroll" className="flex items-center">
                  Get Started
                  <motion.span
